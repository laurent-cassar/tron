...
// Vector3 : représente une position, une direction ou une échelle en 3D.
// Wrapper léger autour de DirectXMath pour avoir une API propre,
// sans exposer XMFLOAT3/XMVECTOR partout dans le reste du code.
struct Vector3
{
    float x, y, z;
    ...
    // Conversions avec DirectXMath (utilisées en interne par Transform/Camera)
